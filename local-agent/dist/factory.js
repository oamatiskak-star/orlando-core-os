...
const CHANNELS = [
    ...
    },
    {
        ...
        target_seconds: 480,
        videos_per_day: 3,
        publish_hours_utc: [9, 13, 17],
        topics: {
            longform: [
                'Vastgoed aankopen in Nederland — complete gids voor 2026',
                'Off-market vastgoed vinden — zo doe je het zonder makelaar',
                'De Aquier methode — slim aankopen zonder overbieden',
                'Bieden onder vraagprijs — bewezen onderhandelingsstrategie',
                'Vastgoed due diligence — 10 checks voor je bod uitbrengt',
                'Bouwtechnische keuring — wat moet je weten voor aankoop?',
                'Splitsingsvergunning aanvragen — zo vergroot je de waarde',
                'Appartement vs eengezinswoning — welke investering wint in 2026?',
                'Aankoopmakelaar vs zelf kopen — kosten en risico vergeleken',
                'Hoe vind je een goede deal op Funda in een overboden markt?',
                'Verhuurde woning aankopen — rendement en risico berekend',
                'Veiling kopen in Nederland — kansen en valkuilen 2026',
                'Financieringsvoorbehoud slim inzetten — bescherm je bod',
                'Van bezichtiging tot sleuteloverdracht — het volledige koopproces',
                'Erfpacht vs eigendom — wat koop je eigenlijk?',
                'Bouwkundige gebreken ontdekken — 7 verborgen risico\'s',
                'Onderhandelen over de vraagprijs — 5 technieken die werken',
                'Hoe gebruik je Aquier om sneller deals te vinden?',
                'Kosten koper berekenen — wat betaal je echt bij aankoop?',
                'Transformatievastgoed kopen — kansen in kantoren en winkels',
                'Starterswoning vs beleggingspand — wat koop je als eerste?',
                'Vastgoed aankopen met partner — juridisch en financieel geregeld',
                'VvE onderzoek voor aankoop — dit moet je controleren',
                'Energielabel E, F of G — kopen of vermijden?',
                'Hoe beoordeel je een taxatierapport als koper?',
                'Hypotheek voor vastgoedbelegger — wat kan je lenen?',
                'Overwaarde gebruiken voor aankoop tweede woning',
                'Nieuwbouw vs bestaand — voor- en nadelen voor investeerders',
                'Huurprijzen 2026 — hoeveel kun je vragen als verhuurder?',
                'Renovatieproject aankopen — zo bereken je de marge vooraf',
            ],
            short: [
                'Off-market deal vinden in 60 seconden — zo doe je het',
                '3 fouten die kopers maken bij overbieden',
                'Bieden onder vraagprijs — dit werkt écht',
                'Bouwtechnische keuring — waarom het altijd loont',
                'Splitsing aanvragen — zo verdien je €50.000 extra',
                'Aquier uitgelegd — slim vastgoed aankopen',
                'Due diligence checklist voor vastgoedkopers',
                'Funda alert instellen — zo mis je niks',
                'Verhuurde woning kopen — rendement in 60 sec berekend',
                'Veiling kopen — dit moet je weten',
                'Kosten koper — dit zijn de echte aankoop kosten',
                'Energielabel G — kopen of skippen?',
                'VvE check voor aankoop — 3 rode vlaggen',
                'Onderhandelen over vraagprijs — 1 simpele truc',
                'Transformatievastgoed — kansen die niemand ziet',
                'Overwaarde gebruiken — zo financier je je volgende deal',
                'Hypotheek als belegger — dit zijn de regels in 2026',
                'Nieuwbouw vs bestaand — wat levert meer op?',
                'Huurprijs bepalen — zo bereken je het correct',
                'Renovatiemarge berekenen — formule uitgelegd',
            ],
        },
    },
    {
        id: '682d74ab-05e4-466c-b6f1-7cf44e96b2f3',
        naam: 'AquierTvEs',
        language: 'es',
        voice: 'es-ES-AlvaroNeural',
        bg_color: '#1a0a00',
        style: 'profesional, estratégico, enfocado en adquisición inmobiliaria en España y LATAM',
        target_seconds: 480,
        videos_per_day: 3,
        publish_hours_utc: [10, 14, 18],
        topics: {
            longform: [
                ...
                'Negociar el precio de compra — estrategias probadas 2026',
                ...
                'Comprar vivienda en subasta en España — oportunidades 2026',
                'Cómo calcular la rentabilidad bruta y neta de un inmueble',
                'Financiación hipotecaria para inversores en España 2026',
                'Reforma de inmuebles — cómo calcular el margen de beneficio',
                'Plusvalía municipal — todo lo que necesitas saber antes de comprar',
                'Inversión inmobiliaria en LATAM — oportunidades y riesgos 2026',
                'Cómo negociar con el banco para conseguir mejor hipoteca',
                'Pisos turísticos vs alquiler tradicional — qué renta más en 2026',
                'Comunidad de propietarios — qué revisar antes de comprar',
                'Cómo usar Aquier para encontrar más y mejores deals',
                'Vivienda de protección oficial — puede ser inversión?',
                'Valoración inmobiliaria — cómo saber si el precio es justo',
                'Gastos de compraventa en España — todos los costes explicados',
                'Inversión en locales comerciales para transformar en vivienda',
                'Cómo escalar de 1 a 5 propiedades sistemáticamente',
                'Gestión de alquileres — self-manage vs agencia inmobiliaria',
                'Certificado energético — qué letra comprar y cuál evitar',
                'IBI, comunidad y gastos de mantenimiento — calcúlalos bien',
                'Inversión inmobiliaria con socios — cómo estructurar el acuerdo',
                'De la visita a la firma — el proceso completo de compra explicado',
            ],
            short: [
                'Encontrar oferta off-market en 60 segundos — así se hace',
                '3 errores que cometen los compradores al pujar',
                'Negociar precio de compra — esto funciona de verdad',
                'Inspección técnica — por qué siempre vale la pena',
                'División de finca — gana €50.000 extra con este truco',
                'Aquier explicado — compra inmuebles de forma inteligente',
                'Checklist due diligence para compradores de inmuebles',
                'Alerta Idealista — no te pierdas ninguna oportunidad',
                'Comprar vivienda alquilada — rentabilidad en 60 segundos',
                'Subasta inmobiliaria — lo que debes saber',
                'Gastos de compra en España — lo que nadie te dice',
                'Certificado energético G — comprar o evitar?',
                'Revisión comunidad de propietarios — 3 señales de alarma',
                'Negociar con el banco — 1 truco sencillo que funciona',
                'Transformar local en vivienda — oportunidades que nadie ve',
                'Usar la plusvalía para financiar tu próxima compra',
                'Hipoteca para inversor — así funcionan las reglas en 2026',
                'Obra nueva vs segunda mano — qué es más rentable?',
                'Calcular precio de alquiler — la fórmula correcta',
                'Margen de reforma — cómo calcularlo antes de comprar',
            ],
        },
    },
];
...
async function getRecentTopics(channelId) {
    const { data } = await db
        .from('agent_tasks')
        .select('payload')
...
async function findNextSlot(channelId, publishHours, afterMs = Date.now() + 60 * 60 * 1000) {
    ...
    const takenSet = new Set((taken ?? []).map(r => new Date(r.scheduled_publish_at).toISOString()));
...
// ─────────────────────────────────────────────────────────────────────────────
async function createTask(ch, videoType, topic) {
    const publishDate = new Date().toISOString().split('T')[0];
    const calendarId = (0, crypto_1.randomUUID)();
...
async function assignPendingSlots(ch) {
        ...
        try {
            ...
            if (deficit > 0) {
                ...
                for (let i = 0; i < deficit; i++) {
                    const videoType = i % 3 === 2 ? 'short' : 'longform';
