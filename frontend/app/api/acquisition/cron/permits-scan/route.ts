...
// Vercel cron — /api/acquisition/cron/permits-scan
// Schedule: 0 7 * * * (dagelijks om 07:00)
// Beveiligd via Bearer CRON_SECRET.
//
// Triggert PermitsScraper worker op Render acquisition-engine
// Scraapt recente bouwvergunningen uit IMOW (laatste 30 dagen)
// Voegt toe aan acq_permits tabel voor opportunities analyse
...
export async function GET(req: NextRequest) {
  ...
  try {
    const response = await fetch(`${engineUrl}/workers/permits-scraper/run`, {
      method: 'POST',
