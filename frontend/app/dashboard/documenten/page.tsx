    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {folders.map((f) => (
            <button key={f.naam} className="bg-white/[0.06] border border-white/5 rounded-xl p-4 flex flex-col gap-3 text-left hover:bg-white/[0.09] hover:border-white/10 transition-colors group">
              ...
              <div>
                ...
                <p className="text-[11px] text-white/50">{f.count} bestand{f.count !== 1 ? 'en' : ''}</p>
              </div>
            </button>
          ))}
        </div>
      ...
      <div className="bg-white/[0.06] border border-white/5 rounded-xl p-5">
        ...
        <div className="space-y-1">
          {recentFiles.map((file, i) => (
            <div key={i} className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-white/[0.06] transition-colors group cursor-pointer">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-white/50">{file.map} · {file.datum}</p>
              </div>
              <span className="text-[11px] text-white/45 flex-shrink-0">{file.size}</span>
            </div>
          ))}
        </div>
      </div>
