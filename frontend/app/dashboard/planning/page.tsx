    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-white/65 mt-0.5">Projectplanning, mijlpalen en capaciteit</p>
        </div>
      ...
      <div className="bg-white/[0.06] border border-white/8 rounded-xl p-8 flex flex-col items-center justify-center gap-3">
        <FolderKanban size={32} className="text-white/50" />
        <p className="text-sm text-white/50">Nog geen planningsitems aangemaakt</p>
