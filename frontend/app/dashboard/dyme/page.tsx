  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-white/40 mt-0.5">Persoonlijk financieel overzicht gekoppeld aan Dyme</p>
      </div>
      ...
      <div className="bg-white/[0.03] border border-white/8 rounded-xl p-8 flex flex-col items-center gap-3">
        <Coins size={32} className="text-white/15" />
        <p className="text-sm text-white/30">Dyme koppeling nog niet geconfigureerd</p>
