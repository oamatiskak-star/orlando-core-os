  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-white/65 mt-0.5">Posts, analytics en contentplanning voor Instagram</p>
      </div>
      ...
      <div className="bg-white/[0.06] border border-white/8 rounded-xl p-8 flex flex-col items-center gap-3">
        ...
        <p className="text-sm text-white/50">Instagram account nog niet gekoppeld</p>
