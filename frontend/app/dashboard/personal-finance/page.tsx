  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-white/65 mt-0.5">Persoonlijk vermogensbeheer, beleggingen en financiële doelen</p>
      </div>
      ...
      <div className="bg-white/[0.06] border border-white/8 rounded-xl p-8 flex flex-col items-center gap-3">
        <BadgeDollarSign size={32} className="text-white/50" />
        <p className="text-sm text-white/50">Vermogensoverzicht nog niet geconfigureerd</p>
