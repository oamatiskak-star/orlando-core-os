...
const SUB_NAV: SubNavEntry[] = [
  ...
  { href: '/dashboard/account-setup/revenue',         label: 'Revenue',          icon: Wallet,      status: 'planned', phase: 2 },
  { href: '/dashboard/account-setup/kyc',             label: 'KYC / Verification',icon: ShieldCheck, status: 'planned', phase: 2 },
  { href: '/dashboard/account-setup/links',           label: 'Affiliate Links',  icon: LinkIcon,    status: 'planned', phase: 2 },
