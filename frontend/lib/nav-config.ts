...
export const NAV_MODULES: Record<string, NavModuleDef> = {
  ...
  tracker_dagprioriteit: { key: 'tracker_dagprioriteit', label: 'Dagprioriteit',        href: '/dashboard/build-tracker/dagprioriteit', icon: CalendarClock },
  build_war_room:      { key: 'build_war_room',      label: 'Build War Room',          href: '/dashboard/build-tracker/war-room',  icon: Network },
...
export const COMPANY_NAV: Record<string, CompanyNav> = {
  ...
  osm: {
    sections: [
      ...
      { title: 'Operationeel', modules: ['build_tracker', 'tracker_canonical', 'tracker_dagprioriteit', 'build_war_room', 'osm', 'accounts', 'agenda', 'taken', 'planning', 'crm'] },
  ...
  'modiwe-software': {
    sections: [
      ...
      { title: 'Finance', modules: ['finance_incasso'] },
      { title: 'Operationeel', modules: ['build_tracker', 'tracker_canonical', 'tracker_dagprioriteit', 'build_war_room', 'osm','accounts', 'planning', 'crm', 'documenten', 'agenda', 'taken'] },
      { title: 'Routines Control', modules: ['routines_hub', 'routines_live', 'routines_agents', 'routines_logs'] },
    ],
    globalBottom: ['meldingen', 'instellingen'],
  },
  ...
  strkbeheer: {
    sections: [
      ...
      { title: 'Finance', modules: ['finance_incasso', 'abonnementen'] },
      { title: 'Operationeel', modules: ['build_tracker', 'tracker_canonical', 'tracker_dagprioriteit', 'build_war_room', 'osm','accounts', 'documenten', 'agenda', 'taken'] },
      { title: 'Routines Control', modules: ['routines_hub', 'routines_live', 'routines_agents', 'routines_logs'] },
    ],
    globalBottom: ['meldingen', 'instellingen'],
  },
