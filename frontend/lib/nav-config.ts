...
export const COMPANY_NAV: Record<string, CompanyNav> = {
  ...
  osm: {
    sections: [
      ...
      { title: 'Operations Center', modules: ['ops_dashboard', 'ops_workflows', 'ops_routines', 'ops_agents', 'ops_worker_control', 'ops_ai_optimizer', 'ops_dispatch', 'ops_hermes', 'ops_scheduler', 'ops_queue', 'ops_logs', 'ops_errors', 'ops_automations', 'ops_api', 'ops_dil', 'ops_suggestions', 'ops_manual', 'ops_templates', 'ops_webhooks', 'ops_analytics', 'ops_company_settings', 'ops_global_settings', 'infra', 'worktree_manager'] },
