...
export const COMPANY_NAV: Record<string, CompanyNav> = {
  ...
  osm: {
    sections: [
      ...
      { title: 'Operationeel', modules: ['build_tracker', 'tracker_canonical', 'tracker_dagprioriteit', 'osm', 'accounts', 'agenda', 'taken', 'planning', 'crm'] },
  ...
  modiwerijo: {
    sections: [
      ...
      { title: 'Operationeel', modules: ['build_tracker', 'tracker_canonical', 'tracker_dagprioriteit', 'osm','accounts', 'projecten', 'planning', 'crm', 'documenten', 'agenda', 'taken'] },
  ...
  'modiwe-software': {
    sections: [
      ...
      { title: 'Finance', modules: ['finance_incasso'] },
      { title: 'Operationeel', modules: ['build_tracker', 'tracker_canonical', 'tracker_dagprioriteit', 'osm','accounts', 'planning', 'crm', 'documenten', 'agenda', 'taken'] },
      { title: 'Routines Control', modules: ['routines_hub', 'routines_live', 'routines_agents', 'routines_logs'] },
    ],
    globalBottom: ['meldingen', 'instellingen'],
  },
  ...
  strkbeheer: {
    sections: [
      ...
      { title: 'Finance', modules: ['finance_incasso', 'abonnementen'] },
      { title: 'Operationeel', modules: ['build_tracker', 'tracker_canonical', 'tracker_dagprioriteit', 'osm','accounts', 'documenten', 'agenda', 'taken'] },
      { title: 'Routines Control', modules: ['routines_hub', 'routines_live', 'routines_agents', 'routines_logs'] },
    ],
    globalBottom: ['meldingen', 'instellingen'],
  },
