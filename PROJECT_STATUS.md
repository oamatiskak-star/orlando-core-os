...
- **OPEN (Orlando):** (1) migratie 124 toepassen op DB `shaunumewswpxhmgbtvv`; (2) `bash scripts/install-hermes-hook.sh` draaien (1×) om hook te bedraden. Daarna ziet Hermes live de Claude-sessiestatus.
